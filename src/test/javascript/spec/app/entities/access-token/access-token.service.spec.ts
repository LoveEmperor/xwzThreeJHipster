    ...
    describe('AccessToken Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/access-tokens';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AccessToken', () => {
                service.create(new AccessToken(null)).subscribe(received => {
            ...
            it('should update a AccessToken', () => {
                service.update(new AccessToken(123)).subscribe(received => {
