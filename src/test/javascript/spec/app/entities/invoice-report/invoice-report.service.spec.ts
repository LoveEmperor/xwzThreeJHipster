    ...
    describe('InvoiceReport Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/invoice-reports';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a InvoiceReport', () => {
                service.create(new InvoiceReport(null)).subscribe(received => {
            ...
            it('should update a InvoiceReport', () => {
                service.update(new InvoiceReport(123)).subscribe(received => {
            ...
            it('should return a InvoiceReport', () => {
            ...
            it('should return a list of InvoiceReport', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new InvoiceReport(123)]);
            });
